...
def hook_switcher(model, name):
    ...
    elif name in [ 'refcocog_val_leaves_umd','refcocog_train_umd', 'coco_my_dataset_val', 'coco_2017_val_panoptic_with_sem_seg', 'ade20k_panoptic_val', 'coco_2017_test-dev']:
